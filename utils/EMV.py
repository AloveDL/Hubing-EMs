...
def save_video(video_tensor):
    ...
    writer = cv2.VideoWriter("out/out.avi", fourcc, 30, (width, height), 1)
    for i in range(0, video_tensor.shape[0]):
...
#
#     # magnify_color("C:\\Users\\27635\\Desktop\\公司实习\\code\\Hubing-EMs\\video\\baby.mp4", 0.4, 3)
#     # magnify_color("./video/demo.avi", 0.4, 3)
#     magnify_motion("video/demo.avi", 0.4, 3)
